	...
	<header>
		<nav>
			...
			<ul id="navli">
				...
				<li><a class="homeblack" href="actview.php">CoCurricular</a></li>
				<li><a class="homered" href="act2view.php">Extracurricular</a></li>
	...
	<div class="divider"></div><br>
                ...
                <?php
                   ...
                   if(isset($_POST['search'])) {
                       ...
                       $sql = "SELECT * FROM excact WHERE regno LIKE '%$searchKey%'";
    
                   }else{
                       $sql = "SELECT * FROM excact";
                       $searchKey = "";
                   }
       ...
       <?php
				while ($employee = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td>".$employee['3.Details']."</td>";
                    echo "<td><a href=\"act2app.php?regno=$employee[regno]\"  onClick=\"return confirm('Are you sure you want to Approve the request?')\">Approve</a> | <a href=\"act2rej.php?regno=$employee[regno]\" onClick=\"return confirm('Are you sure you want to Cancel the request?')\">Reject</a></td>";
					echo "<td><a href=\"act2com.php?regno=$employee[regno]\"  onClick=\"return confirm('Are you sure you want to Submit the request?')\">Remark</a>" ;
