  ...
  <header>
		<nav>
			...
			<ul id="navli">
				...
				<li><a class="homeblack" href="act2view.php">Ex-Curricular</a></li>
...
$res = mysqli_query($mysqli, "UPDATE `excact` SET `remark`='$rej' WHERE regno= $regno;");
	if ($res) {
    $_SESSION['rec']="Data Submitted Successfully";
    header("Location: act2com.php");
}
else{
